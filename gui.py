...
def generate_odds():
    ...
    try:
        ...
        if auto_detect_var.get():
            first_card = analyze_first_community_card(
            ...
            community_cards = (
                [card.strip().lower() for card in community_cards_input.split(",")]
        ...
        # Run the simulation
        output = simulate_poker_round(
            player_cards, num_opponents=num_opponents, community_cards=community_cards
        )
...
opponent_label = tk.Label(
    window, text="Opponents:", font=("Helvetica", 10), fg="#FFFFFF", bg="#121212"
)
opponent_label.pack(pady=2)
opponent_input = tk.Entry(
    window,
    font=("Helvetica", 10),
    width=5,
    bg="#1E1E1E",
...
community_cards_label = tk.Label(
    window, text="Community Cards:", font=("Helvetica", 10), fg="#FFFFFF", bg="#121212"
)
community_cards_label.pack(pady=2)
community_cards_entry = tk.Entry(
    window,
    font=("Helvetica", 10),
    width=20,
    bg="#1E1E1E",
